...
<div class="row"><label>Access<select name="access_policy"><option value="private">Private</option><option value="shared">Shared</option></select></label><label>Autonomy<select name="risk_level"><option value="human-approval">Human approval - manual</option><option value="agent">Agent supervised - smart</option><option value="autonomous">Autonomous - no approval</option></select></label></div>
